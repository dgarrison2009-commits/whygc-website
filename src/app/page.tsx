    ...
    >
      ...
      >
        <div style={{ maxWidth: "720px" }}>
          ...
          <p style={{ marginTop: "24px", fontSize: "0.9rem", color: dark.muted }}>
            Or text us what your team runs on:{" "}
            <a href="sms:+14708525400" style={{ color: accent, fontWeight: 600, textDecoration: "none" }}>
              (470) 852-5400
            </a>
          </p>
        </div>
